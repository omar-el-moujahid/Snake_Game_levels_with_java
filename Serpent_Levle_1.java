...
public class Serpent_Levle_1 extends JFrame {
...
// horloge 
		...
		horloge = new Timer(vitesse, new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				for(int i=1;i<serpent.size();i++) {
					if(serpent.get(0).x + largeur ==margeX || serpent.get(0).y + largeur  ==margeY 
							|| serpent.get(0).y ==margeY + nbCasesY * largeur
							|| serpent.get(0).x   ==margeX + nbCasesX * largeur) {
						horloge.stop();	
						int option = JOptionPane.showConfirmDialog(null, "Your Score is " 
						+ score + "\n Do you want to repeat the game?", "Game Over",
	...
	public static void main(String[] args) {
		Serpent_Levle_1 serpent =new Serpent_Levle_1() ;
